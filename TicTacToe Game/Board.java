// класс Board является ключевым компонентом в архитектуре игры "Крестики-Нолики" (Tic-Tac-Toe).

// Его основная цель — моделировать и управлять состоянием игрового поля 3x3.
